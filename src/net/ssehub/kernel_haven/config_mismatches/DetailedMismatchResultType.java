...
/**
 * Categorizes the results of the {@link DetailedConfigMismatchDetector}.
 * 
 * @author El-Sharkawy
 * @author Slawomir Duszynski
 */
public enum DetailedMismatchResultType {
    /*
     * M - Feature Model
     * E - Feature Effect
     * 
    ...
    PARTIAL_OVERLAP_DEAD("VarModel and formula partially overlap,"
            + " but only if the feature is false"),                  // TRUE TRUE TRUE, + additional check for this case
     ...
     * - the dead feature case can only happen for PARTIAL_OVERLAP. This is because in the other cases M or E are
     *         entirely within the set intersection, and they (per assumption) do not contain dead or always-selected
     *         features. 
     */
     ...
     */
    private DetailedMismatchResultType(@NonNull String description) {
